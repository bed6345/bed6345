...
const std::unordered_map<std::string, std::string> &Lang::defaults()
{
    static const std::unordered_map<std::string, std::string> kDefaults = {
        ...
        {"members_add_button", "§a+ เพิ่มสมาชิก"},
        {"member_line", "{} §7({})"},
        {"add_member_title", "§bเพิ่มสมาชิก"},
        {"add_member_player", "เลือกผู้เล่น (ออนไลน์)"},
        {"add_member_level", "ระดับสมาชิก"},
        {"no_players_online", "§eไม่มีผู้เล่นออนไลน์ที่สามารถเพิ่มได้"},
